...
#define 	BYTES_IN_RXFIFO     0xFF  						//byte number in RXfifo

/****************************************************************/
byte PaTabel[8] = {0x12 ,0x12 ,0x12 ,0x12 ,0x12 ,0x12 ,0x12 ,0x12};
...
void ELECHOUSE_CC1101::RegConfigSettings(void) 
{
    ...
    SpiWriteReg(CC1101_MDMCFG2,  0x03);   // FSK
...
short  ELECHOUSE_CC1101::GetRSSI(void)
{
	...
	//get RSSI
	RSSI_dec = SpiReadStatus(CC1101_RSSI);
